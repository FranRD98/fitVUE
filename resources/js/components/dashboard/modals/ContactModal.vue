      ...
      <div class="p-4 overflow-y-auto flex-1 space-y-4">
        <div class="flex gap-2">
          <button
            ...
            :class="type === 'sugerencia' ? 'border-[var(--color-primary)] text-[var(--color-primary)]' : 'border-gray-200 text-gray-600'"
          >
            Sugerencia
          </button>
          <button
            ...
            @click="type = 'error'"
            class="flex-1 border-2 rounded-xl px-3 py-2.5 text-sm font-semibold"
            :class="type === 'error' ? 'border-[var(--color-primary)] text-[var(--color-primary)]' : 'border-gray-200 text-gray-600'"
          >
            Informe de error
          </button>
        </div>
